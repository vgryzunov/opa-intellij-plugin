...
import com.github.vgryzunov.opaintellijplugin.lang.psi.RegoImport
import com.github.vgryzunov.opaintellijplugin.lang.psi.RegoPackage
...
fun fileDirectChildOfRoot(project: Project, name: String): Boolean {
    val allfiles = FilenameIndex.getVirtualFilesByName(name, GlobalSearchScope.allScope(project))
