 ...
 *
 * note: this enum list should be kept in sync with [com.github.vgryzunov.opaintellijplugin.ide.highlight.RegoHighlighter].
 ...
 *
 * @see com.github.vgryzunov.opaintellijplugin.ide.colors.RegoColorSettingsPage
 * @see com.github.vgryzunov.opaintellijplugin.ide.highlight.RegoHighlighter
 */
enum class RegoColor(humanName: String, val default: TextAttributesKey? = null) {
    ...
    val textAttributesKey = TextAttributesKey.createTextAttributesKey("com.github.vgryzunov.opaintellijplugin.$name", default)
    val attributesDescriptor = AttributesDescriptor(humanName, textAttributesKey)

    // create a new severity with the name of the rego color. It useful to test highlighting.
    // see [com.github.vgryzunov.opaintellijplugin.ide.highlight.AnnotatorTestBase.setUp] for more information
